...
directoryName =r"C:\Users\Rose\Desktop\success\speech-emotion-recognition-master\dataset\Sad" # put your own directory here
# directory to put our results in, you can change the name if you like
resultsDirectory = directoryName + "/sad"
