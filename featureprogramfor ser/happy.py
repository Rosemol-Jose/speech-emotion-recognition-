...
directoryName =r"C:\Users\Rose\Desktop\success\speech-emotion-recognition-master\dataset\Happy" # put your own directory here
# directory to put our results in, you can change the name if you like
resultsDirectory = directoryName + "/happy"
